Param (
    [Parameter(Mandatory=$true)][ValidateSet("CU118", "CU126", "CU128", "CPU")][string]$Device,
...
switch ($Device) {
    ...
    "CU118" {
        Write-Info "Installing PyTorch For CUDA 11.8..."
        Invoke-Pip torch torchaudio --index-url "https://download.pytorch.org/whl/cu118"
    }
    "CPU" {
